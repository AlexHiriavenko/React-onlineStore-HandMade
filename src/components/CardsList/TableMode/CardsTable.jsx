            ...
            <table className={s.table}>
                <thead>
                    <tr>
                        ...
                        <th className={s.tableCell}>color</th>
                        <th className={s.tableCell}>image</th>
                        {cards[0].quantity ? <th className={s.tableCell}>quantity</th> : null}
                        {cards[0].sum ? <th className={s.tableCell}>sum</th> : null}
                ...
                <tbody>
                    {cards.map((card) => (
                        <TableContent key={card.articul} card={card} assignment={assignment} />
                    ))}
                </tbody>
            </table>
        </div>
